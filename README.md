...
| Apartado | Ejercicios                                                     |
| -------- |----------------------------------------------------------------|
| a. Servicios RESTful | [ej2a1](2a/ej2a1.py) [ej2a2](2a/ej2a2.py) [ej2a3](2a/ej2a3.py) |
| b. Introducción a Flask | [ej2b1](2b/ej2b1.py) [ej2b2](2b/ej2b2.py) [ej2b3](2b/ej2b3.py) [ej2b4](2b/ej2b4.py) |
| c. Creación de un servicio REST | [ej2c1](2c/ej2c1.py) [ej2c2](2c/ej2c2.py) [ej2c3](2c/ej2c3.py) |
| d. Control de errores en Flask | [ej2d1](2d/ej2d1.py) [ej2d2](2d/ej2d2.py) [ej2d3](2d/ej2d3.py) |
| e. Manejo de datos de la petición | [ej2e1](2e/ej2e1.py) [ej2e2](2e/ej2e2.py) [ej2e3](2e/ej2e3.py) |
| f. Modularidad de APIs con Blueprints | [ej2f1](2f/ej2f1.py) |
